...
- (void) multipartFormDataParser:(MultipartFormDataParser*)parser processPreambleData:(NSData*) data;
- (void) multipartFormDataParser:(MultipartFormDataParser*)parser processEpilogueData:(NSData*) data;
